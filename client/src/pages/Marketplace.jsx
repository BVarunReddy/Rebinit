...
import { Plus, X, Upload, MapPin, Package } from "lucide-react";
...
const SELLABLE_CATEGORIES = CATEGORIES.filter((c) => c !== "trash"); // you can't list trash for sale
  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "32px 24px" }}>
        ...
        {/* Filters — category colors kept here since they're functional (identifying material type), not decoration */}
        <div
          style={{
            display: "flex",
            gap: 8,
